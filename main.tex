...
\begin{document}
  ...
  \begin{itemize}
    ...
    \item 1 soluzione: le parabole si intersecano in un punto e gli assi di simmetria sono tutti paralleli fra loro.
    \item nessuna soluzione: le parabole non si intersecano fra loro
  \end{itemize}
